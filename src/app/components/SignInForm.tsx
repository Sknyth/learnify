		...
		<form
			...
			<div className="flex flex-col gap-3">
				<div className="flex flex-col gap-2">
					...
					<input type="email" id="email" name="email" placeholder="Enter your email" className="bg-gray-100 border border-gray-300 rounded-xl px-4 py-2 focus:outline-none focus:ring-1 focus:ring-[#4f46e5] focus:border-transparent transition-all" value={email} onChange={(e) => setEmail(e.target.value)} />
				</div>
